# Slice packet — `residual:return` (weave/containers, tier agent)

Frozen 2026-08-11: **17 fns**, unlock estimate 2.6 present_fns. This packet is the slice brief — the enumeration and denominator are FROZEN here; the agent session starts at the sub-shape census.
